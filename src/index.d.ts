...
import { ViewProps, ViewStyle, ImageStyle, TextStyle, StyleProp, NativeSyntheticEvent, NativeScrollEvent } from "react-native"
...
export class SwitchSelector extends Component<SwitchSelectorProps> { }
